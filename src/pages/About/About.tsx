      ...
      <div>
        <HeaderParagraph title={'About me'}>
          <p className="whitespace-pre-wrap text-justify font-light">
            ...
            applications. So far, I have accumulated over two years of hands-on
            experience in this field. In addition to this, I want to mention
            that I've also graduated with a Bachelor's Degree in Computer
            ...
            articles/books about random aspects of history as this is my second
            biggest passion. However, if I want to simply relax I usually spend
            my time playing games, reading a fictional book, 3D modeling or
            practicing my Portuguese. &#10;&emsp;Please feel free to take a look
            at my resume and enjoy the rest of your {currentDay} 😄
          </p>
        </HeaderParagraph>
        <Button
